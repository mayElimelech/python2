...
question_label = tk.Label(window, text="What's your favorite video?")
question_label.pack()
...
# Call the function with the sentence to be spoken
...
image = Image.new('RGB', (500, 500), 'pink')
first = (
...
connect_points(first, image)
connect_points(second, image)
image.show()
